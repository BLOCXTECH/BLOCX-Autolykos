...
By default, blocx_testnetd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent blocx_testnetd from writing mempool.dat to disk. Verify that `savemempool` fails")
