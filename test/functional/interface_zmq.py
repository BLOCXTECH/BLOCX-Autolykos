...
from test_framework.messages import blocx_testnethash
...
def blocx_testnethash_helper(b):
    return encode(blocx_testnethash(b)[::-1], 'hex_codec').decode('ascii')
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], blocx_testnethash_helper(block[:80]))
