...
"""Verify that starting blocx_testnetd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blocx_testnetd with -h for help text")
        ...
        self.log.info("Start blocx_testnetd with -version for version information")
        ...
        self.log.info("Start blocx_testnetdd with -fakearg to make sure it does not start")
