...
"""Tests around blocx_testnet governance objects."""
...
class BLOCX_TESTNETGovernanceTest (BLOCX_TESTNETTestFramework):
    def set_test_params(self):
        self.set_blocx_testnet_test_params(2, 1)
...
if __name__ == '__main__':
    BLOCX_TESTNETGovernanceTest().main()
