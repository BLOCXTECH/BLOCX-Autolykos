...
"""Test the blocx_testnet specific ZMQ notification interfaces."""
...
from test_framework.test_framework import BLOCX_TESTNETTestFramework
...
class BLOCX_TESTNETZMQTest (BLOCX_TESTNETTestFramework):
    def set_test_params(self):
        ...
        self.set_blocx_testnet_test_params(5, 4, fast_dip3_enforcement=True, extra_args=extra_args)
        self.set_blocx_testnet_llmq_test_params(4, 4)
    ...
    def run_test(self):
        self.subscribers = {}
        # Check that blocx_testnetd has been built with ZMQ enabled.
        ...
        try:
            ...
            time.sleep(1)
            # Test all blocx_testnet related ZMQ publisher
