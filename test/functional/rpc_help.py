...
class HelpRpcTest(BitcoinTestFramework):
    ...
    def test_categories(self):
        ...
        # wrong argument count, note: BLOCX_TESTNET's help allows for two options since we utilize subcommands
        ...
        components = ['Addressindex', 'Blockchain', 'Control', 'BLOCX_TESTNET', 'Evo', 'Generating', 'Mining', 'Network', 'Rawtransactions', 'Util']
