...
# TestP2PConn: A peer we use to send messages to blocx_testnetd, and store responses.
...
#            "-txindex",
    ...
    # This test actually causes blocx_testnetd to (reasonably!) disconnect us, so do this last.
    ...
    # blocx_testnetd's choice of nonce.
    ...
    # Test that blocx_testnetd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, test_node):
        ...
        # Note that it's possible for blocx_testnetd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, test_node):
        node = self.nodes[0]
        # blocx_testnetd will not send blocktxn responses for blocks whose height is
