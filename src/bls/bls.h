...
#ifndef BLOCX_TESTNET_CRYPTO_BLS_H
#define BLOCX_TESTNET_CRYPTO_BLS_H
...
// bls-blocx_testnet uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <blocxbls/bls.hpp>
#include <blocxbls/privatekey.hpp>
#include <blocxbls/elements.hpp>
#include <blocxbls/schemes.hpp>
#include <blocxbls/threshold.hpp>
#undef DOUBLE
#undef SEED
...
#endif // BLOCX_TESTNET_CRYPTO_BLS_H
