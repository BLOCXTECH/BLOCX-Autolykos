...
static UniValue generateBlocks(ChainstateManager& chainman, const CTxMemPool& mempool, CEvoDB& evodb, llmq::CQuorumBlockProcessor& quorum_block_processor, llmq::CChainLocksHandler& clhandler, llmq::CInstantSendManager& isman, const CScript& coinbase_script, int nGenerate, uint64_t nMaxTries)
{
    int nHeightEnd = 0;
    int nHeight = 0;
...
static UniValue generatetoaddress(const JSONRPCRequest& request)
{
    RPCHelpMan{
        ...
        "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
        {
            ...
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated BLOCX_TESTNET to."},
            {"maxtries", RPCArg::Type::NUM, /* default */ "1000000", "How many iterations to try."},
        },
        RPCResult{
        ...
        RPCExamples{"\nGenerate 11 blocks to myaddress\n" + HelpExampleCli("generatetoaddress", "11 \"myaddress\"") + "If you are running the BLOCX_TESTNET Core wallet, you can get a new address to send the newly generated coins to with:\n" + HelpExampleCli("getnewaddress", "")},
    }
        .Check(request);
...
static UniValue generateblock(const JSONRPCRequest& request)
{
    RPCHelpMan{
        ...
        RPCResult{
            RPCResult::Type::OBJ, "", "", {{RPCResult::Type::STR_HEX, "hash", "hash of generated block"}}},
        RPCExamples{
...
static UniValue estimatesmartfee(const JSONRPCRequest& request)
{
    RPCHelpMan{
        ...
        RPCExamples{HelpExampleCli("estimatesmartfee", "6")},
    }
        .Check(request);
