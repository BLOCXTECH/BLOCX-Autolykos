...
static UniValue debug(const JSONRPCRequest& request)
{
    RPCHelpMan{"debug",
        ...
        " - \"blocx_testnet\" activates all BLOCX_TESTNET-specific categories at once;\n"
        ...
        RPCExamples {
            HelpExampleCli("debug", "blocx_testnet")
    + HelpExampleRpc("debug", "blocx_testnet+net")
    }}.Check(request);
...
static UniValue validateaddress(const JSONRPCRequest& request)
{
            RPCHelpMan{"validateaddress",
                "\nReturn information about the given blocx_testnet address.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The blocx_testnet address to validate"},
                },
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
...
static UniValue verifymessage(const JSONRPCRequest& request)
{
    RPCHelpMan{"verifymessage",
        ...
        {
            {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The blocx_testnet address to use for the signature."},
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "blocx_testnet-cli and the GUI. There is no server-side difference.",
                {},
...
{ //  category              name                      actor (function)         argNames
  //  --------------------- ------------------------  -----------------------  ----------
    ...
    /* BLOCX_TESTNET features */
    { "blocx_testnet",               "mnsync",                 &mnsync,                 {} },
    { "blocx_testnet",               "spork",                  &spork,                  {"command"} },
    { "blocx_testnet",               "sporkupdate",            &sporkupdate,            {"name","value"} },
