...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x"); // 1889000
        ...
        vSeeds.emplace_back("209.145.57.126");
        vSeeds.emplace_back("173.249.23.35");
        vSeeds.emplace_back("89.117.60.32");

        // BLOCX_TESTNET addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,25);
        // BLOCX_TESTNET script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,26);
        // BLOCX_TESTNET private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,153);
        // BLOCX_TESTNET BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // BLOCX_TESTNET BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};

        // BLOCX_TESTNET BIP44 coin type is '5'
        nExtCoinType = 5;
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00000fffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // BLOCX_TESTNET: 1 day
        consensus.nPowTargetSpacing = 2.5 * 60; // BLOCX_TESTNET: 2.5 minutes
    ...
    // -
        ...
        vSeeds.emplace_back("testnet-seed.blocx_testnetdot.io"); // Just a static list of stable node(s), only supports x9

        // Testnet BLOCX_TESTNET addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet BLOCX_TESTNET script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet BLOCX_TESTNET BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet BLOCX_TESTNET BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet BLOCX_TESTNET BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
...
public:
    ...
    // -
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("blocx_testnetevo.org",  "devnet-seed.blocx_testnetevo.org"));
...
public:
    ...
    // -
        ...
        // Regtest BLOCX_TESTNET addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest BLOCX_TESTNET script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest BLOCX_TESTNET BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest BLOCX_TESTNET BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest BLOCX_TESTNET BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
