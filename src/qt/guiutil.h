...
/** Utility functions used by the BLOCX_TESTNET Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "blocx_testnet:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load blocx_testnet specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a blocx_testnet specific theme is activated (light/dark).*/
