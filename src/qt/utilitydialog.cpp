    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        QString header = "Usage:  blocx_testnet-qt [command-line options]                     \n";
...
All the BLOCX_TESTNET in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.001 BLOCX_TESTNET, 0.01 BLOCX_TESTNET, 0.1 BLOCX_TESTNET, 1 BLOCX_TESTNET and 10 BLOCX_TESTNET -- sort of like the paper money you use every day.</li> \
...
For more information, see the <a style=\"%2\" href=\"%3\">%1 documentation</a>."
        ...
        .arg("https://docs.blocx_testnet.org/en/stable/wallets/blocx_testnetcore/coinjoin-instantsend.html")
        );
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
    }
