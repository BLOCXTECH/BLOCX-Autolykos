...
//! Interface for the src/evo part of a blocx_testnet node (blocx_testnetd process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/governance part of a blocx_testnet node (blocx_testnetd process).
class GOV
{
public:
    virtual ~GOV() {}
...
//! Interface for the src/llmq part of a blocx_testnet node (blocx_testnetd process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a blocx_testnet node (blocx_testnetd process).
...
//! Top-level interface for a blocx_testnet node (blocx_testnetd process).
class Node
{
public:
    virtual ~Node() {}
