...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loblocx_testnet.
    var _ = context && context._ || require('loblocx_testnet') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loblocx_testnet methods to
     * make working with arrays, collections, and objects easier. The loblocx_testnet
     * methods are:
     * [`each/forEach`](https://loblocx_testnet.com/docs#forEach), [`forOwn`](https://loblocx_testnet.com/docs#forOwn),
     * [`has`](https://loblocx_testnet.com/docs#has), [`indexOf`](https://loblocx_testnet.com/docs#indexOf),
     * [`map`](https://loblocx_testnet.com/docs#map), and [`reduce`](https://loblocx_testnet.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loblocx_testnet methods to
     * make working with Suites easier. The wrapped loblocx_testnet methods are:
     * [`each/forEach`](https://loblocx_testnet.com/docs#forEach), [`indexOf`](https://loblocx_testnet.com/docs#indexOf),
     * [`map`](https://loblocx_testnet.com/docs#map), and [`reduce`](https://loblocx_testnet.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loblocx_testnet methods to Benchmark.
    ...
    // Add loblocx_testnet methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loblocx_testnet', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
