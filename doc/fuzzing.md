# Fuzzing BLOCX_TESTNET Core using libFuzzer

## Quickstart guide

To quickly get started fuzzing BLOCX_TESTNET Core using [libFuzzer](https://llvm.org/docs/LibFuzzer.html):
...
# libFuzzer" on https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET
$ make
...
[`process_message`](https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/blob/develop/src/test/fuzz/process_message.cpp) is a fuzzing harness for the [`ProcessMessage(...)` function (`net_processing`)](https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/blob/develop/src/net_processing.cpp). The available fuzzing harnesses are found in [`src/test/fuzz/`](https://github.com/blocx_testnetpay/blocx_testnet/tree/develop/src/test/fuzz).
...
Every single pull request submitted against the BLOCX_TESTNET Core repo is automatically tested against all inputs in the [`bitcoin-core/qa-assets`](https://github.com/bitcoin-core/qa-assets) repo. Contributing new coverage increasing inputs is an easy way to help make BLOCX_TESTNET Core more robust.
...
with certain assembly code from BLOCX_TESTNET Core's code. See [developer notes on sanitizers](https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/blob/develop/doc/developer-notes.md#sanitizers)
...
# Fuzzing BLOCX_TESTNET Core using american fuzzy lop (`afl-fuzz`)

## Quickstart guide

To quickly get started fuzzing BLOCX_TESTNET Core using [`afl-fuzz`](https://github.com/google/afl):
...
# Fuzzing BLOCX_TESTNET Core using Honggfuzz

## Quickstart guide

To quickly get started fuzzing BLOCX_TESTNET Core using [Honggfuzz](https://github.com/google/honggfuzz):
