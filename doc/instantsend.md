...
This mechanism has been integrated into Bitcore-Node-BLOCX_TESTNET which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blocx_testnetpay/insight-api-blocx_testnet#web-socket-api](https://github.com/blocx_testnetpay/insight-api-blocx_testnet#web-socket-api)
* API: [https://github.com/blocx_testnetpay/insight-api-blocx_testnet#instantsend-transactions](https://github.com/blocx_testnetpay/insight-api-blocx_testnet#instantsend-transactions)
