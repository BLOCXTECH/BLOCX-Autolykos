# Support for Output Descriptors in BLOCX_TESTNET Core

Since BLOCX_TESTNET Core v0.17, there is support for Output Descriptors. This is a
...
existing BLOCX_TESTNET Core wallets, a convenience function `combo` is
...
All RPCs in BLOCX_TESTNET Core will include the checksum in their output. Only
