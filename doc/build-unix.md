UNIX BUILD NOTES
====================
Some notes on how to build BLOCX_TESTNET Core in Unix.
...
-----------------------
Building the dependencies and BLOCX_TESTNET Core requires some essential build tools and libraries to be installed before.
...
Security
--------
To help make your BLOCX_TESTNET Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, BLOCX_TESTNET Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, BLOCX_TESTNET Core may be compiled in
