...
This document provides guidelines for internationalization of the BLOCX_TESTNET Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blocx_testnet_en.ts` remains unchanged.
