...
RCSUBDIR="test"
HOST1="https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/releases/"
HOST2="https://pasta.keybase.pub/BLOCX_TESTNET-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the BLOCX_TESTNET Core binary release signing key installed?"
   fi
