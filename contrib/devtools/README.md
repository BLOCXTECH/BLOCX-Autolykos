...
Provides utilities for managing copyright headers of `The BLOCX_TESTNET Core
...
BLOCX_TESTNETTECH/BLOCX_TESTNET repository.
...
Setup
---------
Configuring the github-merge tool for the BLOCX_TESTNET Core repository is done in the following way:

    git config githubmerge.repository BLOCX_TESTNETTECH/BLOCX_TESTNET
...
A script to optimize png files in the blocx_testnet
...
If there are any errors the return value will be 1 and output like this will be printed:
    ...
    .../64/test_blocx_testnet: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_blocx_testnet: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_blocx_testnet: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_blocx_testnet: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
