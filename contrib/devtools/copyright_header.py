...
EXCLUDE = [
    # auto generated:
    'src/qt/blocx_testnetstrings.cpp',
...
Arguments:
    <base_directory> - The base directory of a BLOCX_TESTNET Core source code repository.
...
Arguments:
    <base_directory> - The base directory of BLOCX_TESTNET Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BLOCX_TESTNET Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The BLOCX_TESTNET
