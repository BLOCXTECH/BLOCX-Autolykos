Contributing to BLOCX_TESTNET Core
============================

The BLOCX_TESTNET Core project operates an open contributor model where anyone is
...
[good first issue](https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/issues)
list.
...
include:
  ...
  - *qt* for changes to blocx_testnet-qt
...
[Translation Process](https://github.com/BLOCX_TESTNETTECH/BLOCX_TESTNET/blob/master/doc/translation_process.md)
...
The following applies to code changes to the BLOCX_TESTNET Core project (and related
projects such as libsecp256k1), and is not to be confused with overall BLOCX_TESTNET
Network Protocol consensus changes.

Whether a pull request is merged into BLOCX_TESTNET Core rests with the project merge
...
Patches that change BLOCX_TESTNET consensus rules are considerably more involved than
...
Where a patch set proposes to change the BLOCX_TESTNET consensus, it must have been
...
The review process is normally fairly responsive on the BLOCX_TESTNET Core repository, however
...
Bitcoin Backports are an incredibly valuable part of BLOCX_TESTNET's development. Backporting allows us to easily implement new
features, improvements and fixes as bitcoin implements them.

To see detailed statistics & progress see Google Sheet tracker: [Bitcoin backports for BLOCX_TESTNET](https://docs.google.com/spreadsheets/d/1DnKxat0S0H62CJOzXpKGPXTa8hgoVOjGYZzoClmGSB8/edit?usp=sharing).
...
The project leader is the release manager for each BLOCX_TESTNET Core release.
